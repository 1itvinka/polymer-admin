...
It's just the very first version, but we will continue on the template development in order to create the whole framework that can be applied to developing admin dashboards using Polymer.
